...
public class Home extends AppCompatActivity
    ...
    public TextView doctor,donor,patient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String username = prefs.getString("username", "Kalonzo");
     ...
     */
    private void init(){
        doctor = (TextView)findViewById(R.id.uv_doctor) ;
        donor = (TextView)findViewById(R.id.uv_donor);
        patient = (TextView)findViewById(R.id.uv_patient);
